...
class GameView(arcade.View):
    ...
    def setup(self):
        ...
        if self.current_level == 1:
            ...
            self.enemy_list.append(Enemy1(16400, 512, 17030, 16020, 600, ENEMY_MOVEMENT_SPEED))

        if self.current_level == 2:
            self.enemy_list.append(Enemy1(3700, 384, 4100, 3640, 450, ENEMY_MOVEMENT_SPEED))
            self.enemy_list.append(Enemy1(6300, 960, 6772, 5942, 1060, ENEMY_MOVEMENT_SPEED))
            self.enemy_list.append(Enemy1(7400, 1792, 7640, 7006, 1890, ENEMY_MOVEMENT_SPEED))
            self.enemy_list.append(Enemy1(6000, 2304, 7042, 6309, 2400, ENEMY_MOVEMENT_SPEED))
            self.enemy_list.append(Enemy1(10000, 576, 10448, 9400, 670, ENEMY_MOVEMENT_SPEED))

        if self.current_level == 3:
            self.enemy_list.append(Enemy1(1000, 514, 1220, 830, 610, ENEMY_MOVEMENT_SPEED))
            self.enemy_list.append(Enemy1(3000, 512, 3474, 2964, 610, ENEMY_MOVEMENT_SPEED))
            self.enemy_list.append(Enemy1(5000, 768, 5314, 4674, 860, ENEMY_MOVEMENT_SPEED))
            self.enemy_list.append(Enemy1(6500, 384, 6936, 6120, 480, ENEMY_MOVEMENT_SPEED))
            self.enemy_list.append(Enemy1(6700, 384, 6936, 6120, 480, 2.2))
            self.enemy_list.append(Enemy1(8000, 1472, 8828, 7628, 1600, ENEMY_MOVEMENT_SPEED))
            self.enemy_list.append(Boss(14000, 2944, 14512, 13300, 3044, ENEMY_MOVEMENT_SPEED))
        


        
    def player_health_bar(self):
        '''creates healthbar that changes depending on player health'''
